...
import java.util.List;
    ...
    public class DatabaseHandler extends SQLiteOpenHelper {
        ...
        void addHiScore(HighestScore hiScore) {
            SQLiteDatabase db = this.getWritableDatabase();
        ...
        HighestScore getHiScore(int id) {
            ...
            HighestScore hiScore = new HighestScore(Integer.parseInt(
                    cursor.getString(0)),
                    cursor.getString(1),
                    cursor.getString(2),
                    cursor.getInt(3));
        ...
        public List<HighestScore> getAllHiScores() {
            List<HighestScore> hiScoreList = new ArrayList<HighestScore>();
            // Select All Query
            ...
            if (cursor.moveToFirst()) {
                do {
                    HighestScore hiScore = new HighestScore();
        ...
        public int updateHiScore(HighestScore hiScore) {
            SQLiteDatabase db = this.getWritableDatabase();
        ...
        public void deleteHiScore(HighestScore hiScore) {
            SQLiteDatabase db = this.getWritableDatabase();
        ...
        public List<HighestScore> getTopFiveScores() {
            List<HighestScore> hiScoreList = new ArrayList<HighestScore>();
            // Select All Query
            String selectQuery = "SELECT  * FROM " + TABLE_HI_SCORES +
                    " ORDER BY SCORE DESC " +
